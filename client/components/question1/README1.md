...
1. The initial number to be displayed should either be 0, whatever the min prop is if min is greater than 0, or whatever the max prop is if max is less than 0. You can assume that min will always be lower than max.
